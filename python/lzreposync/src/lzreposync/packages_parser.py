...
if __name__ == "__main__":
    packages = decompress_open("/home/haroune/gsoc/uyuni/python/lzreposync/tests/test-files/Packages_ubuntu_jammy_main_amd64.gz")
    print()
    parser = PackagesParser(packages, "path/to")
